...
CREATE TABLE IF NOT EXISTS `TP Bases de Datos`.`Documentos` (
  ...
  `contenido` TEXT NULL,
  `Contenido_idContenido` INT NOT NULL,
  PRIMARY KEY (`idDocumento`, `Contenido_idContenido`),
...
CREATE TABLE IF NOT EXISTS `TP Bases de Datos`.`DescargaDocumento` (
  ...
  PRIMARY KEY (`idDescargaDocumento`, `Documentos_idDocumento`, `Documentos_Contenido_idContenido`),
  INDEX `fk_DescargaDocumento_Documentos1_idx` (`Documentos_idDocumento` ASC, `Documentos_Contenido_idContenido` ASC),
  INDEX `fk_DescargaDocumento_Encuesta1_idx` (`Encuesta_idEncuesta` ASC),
  CONSTRAINT `fk_DescargaDocumento_Documentos1`
    FOREIGN KEY (`Documentos_idDocumento` , `Documentos_Contenido_idContenido`)
    REFERENCES `TP Bases de Datos`.`Documentos` (`idDocumento` , `Contenido_idContenido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `TP Bases de Datos`.`Usuario` (
  ...
  `DescargaDocumento_Documentos_idDocumento` INT NOT NULL,
  ...
  INDEX `fk_Usuario_DescargaDocumento1_idx` (`DescargaDocumento_idDescargaDocumento` ASC, `DescargaDocumento_Documentos_idDocumento` ASC, `DescargaDocumento_Documentos_Contenido_idContenido` ASC),
  ...
  CONSTRAINT `fk_Usuario_DescargaDocumento1`
    FOREIGN KEY (`DescargaDocumento_idDescargaDocumento` , `DescargaDocumento_Documentos_idDocumento` , `DescargaDocumento_Documentos_Contenido_idContenido`)
    REFERENCES `TP Bases de Datos`.`DescargaDocumento` (`idDescargaDocumento` , `Documentos_idDocumento` , `Documentos_Contenido_idContenido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
